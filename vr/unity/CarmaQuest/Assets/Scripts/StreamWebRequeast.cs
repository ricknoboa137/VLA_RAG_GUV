...
using System.IO;
//
public class StreamWebRequeast : MonoBehaviour
{
    public MeshRenderer frame;  //Mesh for displaying video

    private string sourceURL = "https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg";
    ...
    public void GetVideo()
    {
        ...
        // get response stream
        stream = resp.GetResponseStream();        print("Starting Coroutine!");
